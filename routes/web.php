...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::get('/', 'HomeController@index')->name('homeDashboard');
	...
	Route::post('products/update', 'ProductController@updateProduct')->name('product.ajaxUpdate');
	...
	Route::get('open-register', 'CashRegisterController@create')->name('open.register'); // open register
	...
	Route::post('report/warehouse_report', 'ReportController@warehouseReport')->name('report.warehouse.get');

	Route::get('report/warehouse_report', 'ReportController@warehouseReportGet')->name('report.warehouse');
