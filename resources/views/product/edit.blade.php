                            ...
                            <div class="row">
                                        ...
                                        <table id="myTable" class="table table-hover order-list">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control qty" name="product_qty[]" value="{{$qty_list[$key]}}" step="any"></td>
                                                    <td><input type="text" class="form-control unit_price" name="unit_price[]" value="{{$price_list[$key]}}" step="any"/></td>
                                ...
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cost" value="{{$lims_product_data->cost}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price" value="{{$lims_product_data->price}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alert_quantity" value="{{$lims_product_data->alert_quantity}}" class="form-control" step="any">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4" id="promotion_price">   <label>{{trans('file.Promotional Price')}}</label>
                                            <input type="text" name="promotion_price" value="{{$lims_product_data->promotion_price}}" class="form-control" step="any" />
                                        </div>
...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(flag){
                        ...
                        cols += '<td><input type="text" class="form-control qty" name="product_qty[]" value="1" step="any"/></td>';
                        cols += '<td><input type="text" class="form-control unit_price" name="unit_price[]" value="' + data[3] + '" step="any"/></td>';
    ...
    $("input[name='variant']").on("input", function () {
        if($("#code").val() == ''){
            ...
            var item_code = $("#code").val() +'-'+ variant_name;
            var newRow = $("<tr>");
            var cols = '';
