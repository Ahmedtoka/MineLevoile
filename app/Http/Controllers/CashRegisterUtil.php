...
class CashRegisterUtil extends Util
{
    ...
    {
        $product_details = Sale::where('transactions.created_by', $user_id)
        ...
        if ($is_types_of_service_enabled) {
            $types_of_service_details = Sale::where('transactions.created_by', $user_id)
                ->whereBetween('transaction_date', [$open_time, $close_time])
                ->where('transactions.type', 'sell')
                ->where('transactions.status', 'final')
        ...
        $transaction_details = Sale::where('transactions.created_by', $user_id)
                ->whereBetween('transaction_date', [$open_time, $close_time])
                ->where('transactions.type', 'sell')
                ->where('transactions.status', 'final')
                ->select(
