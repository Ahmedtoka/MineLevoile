...
class SaleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($lims_sale_data->sale_status == '1') {
            //record transaction in cash register transaction
